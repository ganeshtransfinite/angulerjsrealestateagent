(function () {
    ...
    angular
            ...
            .directive('chartjsPropertylocationavalineWidget', chartjsPropertylocationavalineWidget);

    /* @ngInject */
    function chartjsPropertylocationavalineWidget($timeout,sessionobject, $interval) {
        // Usage:
        //
        // Creates:
        //
...
//                    }
            ...
            {
                {
                    $scope.LocationPropertyRentSaleAva = {};
                    $scope.LocationPropertyRentSaleAva = {
                        chart: 'chart-line',
                        type: 'Monthly',
                        options: {
