 ...
 * @author Vision
 */
@Entity(name = "Societyamenities")
@JsonIgnoreProperties(ignoreUnknown = true)
@Table(name = "societyamenities")
public class  SocietyamenitiesForm implements Serializable {
     @Column(name = "SOCIETYAMENITIESID")
    @Id
    @GeneratedValue(strategy = GenerationType.AUTO) 
int societyamenitiesid;
@Column(name = "NAME") 
String name;
...
int recordorder;
         public SocietyamenitiesForm() {
    }
    public SocietyamenitiesForm(SocietyamenitiesForm obj) {
...
this.recordorder=obj.recordorder;
   ...
   public void setSocietyamenitiesid(int societyamenitiesid) { this.societyamenitiesid = societyamenitiesid;  }
...
public void setRecordorder(int recordorder) { this.recordorder = recordorder;  }
   public int getSocietyamenitiesid() { return societyamenitiesid; }
