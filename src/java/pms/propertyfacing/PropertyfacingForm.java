 ...
 * @author Vision
 */
@Entity(name = "Propertyfacing")
@JsonIgnoreProperties(ignoreUnknown = true)
@Table(name = "propertyfacing")
public class  PropertyfacingForm implements Serializable {
     @Column(name = "PROPERTYFACINGID")
    @Id
    @GeneratedValue(strategy = GenerationType.AUTO) 
int propertyfacingid;
...
int recordorder;
         public PropertyfacingForm() {
    }
    public PropertyfacingForm(PropertyfacingForm obj) {
...
this.recordorder=obj.recordorder;
   ...
   public void setPropertyfacingid(int propertyfacingid) { this.propertyfacingid = propertyfacingid;  }
...
public void setRecordorder(int recordorder) { this.recordorder = recordorder;  }
   public int getPropertyfacingid() { return propertyfacingid; }
