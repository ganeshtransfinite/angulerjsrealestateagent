 ...
 * @author Vision
 */
@Entity(name = "Propertypriority")
@JsonIgnoreProperties(ignoreUnknown = true)
@Table(name = "propertypriority")
public class  PropertypriorityForm implements Serializable {
     @Column(name = "PROPERTYPRIORITYID")
    @Id
    @GeneratedValue(strategy = GenerationType.AUTO) 
int propertypriorityid;
...
int recordorder;
         public PropertypriorityForm() {
    }
    public PropertypriorityForm(PropertypriorityForm obj) {
...
this.recordorder=obj.recordorder;
   ...
   public void setPropertypriorityid(int propertypriorityid) { this.propertypriorityid = propertypriorityid;  }
...
public void setRecordorder(int recordorder) { this.recordorder = recordorder;  }
   public int getPropertypriorityid() { return propertypriorityid; }
