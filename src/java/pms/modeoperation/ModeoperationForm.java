 ...
 * @author Vision
 */
@Entity(name = "Modeoperation")
@JsonIgnoreProperties(ignoreUnknown = true)
@Table(name = "modeoperation")
public class  ModeoperationForm implements Serializable {
     @Column(name = "MODEOPERATIONID")
    @Id
...
int recordorder;
         public ModeoperationForm() {
    }
    public ModeoperationForm(ModeoperationForm obj) {
...
this.recordorder=obj.recordorder;
   ...
   public void setModeoperationid(int modeoperationid) { this.modeoperationid = modeoperationid;  }
...
public void setRecordorder(int recordorder) { this.recordorder = recordorder;  }
   public int getModeoperationid() { return modeoperationid; }
