...
public class  PropertytypeForm implements Serializable {
...
int recordorder;
    ...
    public PropertytypeForm(PropertytypeForm obj) {
...
this.recordorder=obj.recordorder;
   ...
   public void setPropertytypeid(int propertytypeid) { this.propertytypeid = propertytypeid;  }
...
public void setRecordorder(int recordorder) { this.recordorder = recordorder;  }
   public int getPropertytypeid() { return propertytypeid; }
