(function () {
    ...
    /* @ngInject */
    function DefaultToolbarController($scope, $injector, $rootScope, $mdMedia, $state, $http, sessionobject, $element, $filter, $mdUtil, $mdSidenav, $mdToast, $localStorage, $timeout, $document, triBreadcrumbsService, triSettings, triLayout) {
        var vm = this;
        ...
        vm.fullname = $localStorage.clientloginuserid.user.fullname;
        vm.fullname = $localStorage.clientloginuserid.user.fullname;
        vm.currentUser = $localStorage.clientloginuserid.user.fullname;
        ...
        vm.logout = function () {
            var formData ={};
            var httpPromise = $http(sessionobject.getFileHttpHeader('/logout', formData, "admin"))
