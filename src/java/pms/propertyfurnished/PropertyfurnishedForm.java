 ...
 * @author Vision
 */
@Entity(name = "Propertyfurnished")
@JsonIgnoreProperties(ignoreUnknown = true)
@Table(name = "propertyfurnished")
public class  PropertyfurnishedForm implements Serializable {
     @Column(name = "PROPERTYFURNISHEDID")
    @Id
    @GeneratedValue(strategy = GenerationType.AUTO) 
int propertyfurnishedid;
...
int recordorder;
         public PropertyfurnishedForm() {
    }
    public PropertyfurnishedForm(PropertyfurnishedForm obj) {
...
this.recordorder=obj.recordorder;
   ...
   public void setPropertyfurnishedid(int propertyfurnishedid) { this.propertyfurnishedid = propertyfurnishedid;  }
...
public void setRecordorder(int recordorder) { this.recordorder = recordorder;  }
   public int getPropertyfurnishedid() { return propertyfurnishedid; }
