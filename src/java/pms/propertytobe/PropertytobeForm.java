 ...
 * @author Vision
 */
@Entity(name = "Propertytobe")
@JsonIgnoreProperties(ignoreUnknown = true)
@Table(name = "propertytobe")
public class PropertytobeForm implements Serializable {

    @Column(name = "PROPERTYTOBEID")
    @Id
    ...
    public PropertytobeForm() {
    }

    public PropertytobeForm(PropertytobeForm obj) {
    ...
    public void setPropertytobeid(int propertytobeid) {
