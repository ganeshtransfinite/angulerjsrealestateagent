(function () {
    ...
    angular
            ...
            .directive('chartjsPropertylocationcloselineWidget', chartjsPropertylocationcloselineWidget);

    /* @ngInject */
    function chartjsPropertylocationcloselineWidget($timeout,sessionobject, $interval) {
        // Usage:
        //
        // Creates:
        //
...
//                    }
            ...
            {
                {
                    $scope.LocationPropertyRentSaleClose = {};
                    $scope.LocationPropertyRentSaleClose = {
                        chart: 'chart-bar',
                        type: 'Monthly',
                        options: {
                    ...
                    var s1 = "Location Property Rent Close", s2 = "Location Property Sale Close";
                    ...
                    $scope.LocationPropertyRentSaleClose.Monthly = {
                        labels: labelx,
                        series: [s1, s2],
                        data: data_count
                    };
